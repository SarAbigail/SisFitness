...
import sisfitness.formularios.tablas.ClienteTableModel;
...
public class frmListaClientes extends javax.swing.JFrame {
    ...
    private void ListarClientes()
    {
        ...
        ClienteTableModel prdtable=new ClienteTableModel(bcliente.ListaCliente());
        gridCliente.setModel(prdtable);
    }    
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        frmCliente frmcliente=new frmCliente(this, rootPaneCheckingEnabled,OPCION_NUEVO,null);
        frmcliente.setVisible(true);
        if (frmcliente.isResultstatus())
        {
            ListarClientes();
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            cliente=bcliente.BuscarByID(id);
            frmCliente frmcli=new frmCliente(this, rootPaneCheckingEnabled,OPCION_MODIFICAR,cliente);
            frmcli.setVisible(true);
            if (frmcli.isResultstatus())
            {
                ListarClientes();
            }
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            if (nResultMsg==JOptionPane.YES_OPTION)
            {
                ...
                int nResult=bcliente.GuardarCliente(OPCION_ELIMINAR, cliente);
                if (nResult>0)
                {
                    ListarClientes();
                }
